...
type UserAPIKey struct {
	...
	Provider     Provider  `gorm:"size:50;not null;uniqueIndex:idx_user_provider" json:"provider"` // ProviderOpenRouter, ProviderOpenAI, ProviderAnthropic, ProviderGoogle
